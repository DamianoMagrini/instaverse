export const strs = [
  ...
  '{Submit an appeal text bolded} if you feel this is a mistake and you have the rights to use all of the content in your video. Your video will remain blocked while {reference owner name} reviews your appeal.',
  'Delete this video',
  ...
  'See More',
  'Videos must be between {minLengthInSeconds} seconds and {maxLengthInMinutes} minutes long.',
  ...
  'Submit an appeal only if you have the rights to use all of the material in your video.',
  'Delete Contacts?',
  'Ad Guidelines',
  ...
  'Username',
  "We can save your login info on this phone so you don't need to enter it again.",
  'Block',
  ...
  'Please write an explanation about why you have the rights to use the content in your video.',
  ...
  "There are laws that restrict the use of certain music, audio or video clips if you don't have the rights.",
  '{date} at {time}',
  ...
  'Write an explanation about why you believe that your dispute should not have been rejected. (Required)',
  'Peer-to-peer sales of firearms, explosives and ammunition.',
  'Discover People',
  ...
  'resources',
  'Next',
  'You have no expired applications that had access your Instagram account.',
  ...
  'th',
  'Settings',
  "Don't want to miss what your friends are sharing? {get the app link}",
  ...
  'Submit a dispute if you feel that this is a mistake and you have the rights to use this content.',
  ...
  'They requested videos containing this content to be blocked worldwide.',
  ...
  'Next',
  'Instagram Password',
  'They requested videos containing this content to be blocked in the following countries where they own the rights:',
  'Account Recovery',
  'You sent a story',
  ...
  'Follow Requests',
  'This Wasn’t Me',
  'Thanks for helping us make Instagram better.',
  '{days} days ago',
  ...
  "You shouldn't upload the matched content just because you bought or found it somewhere else.",
  'Copy Link',
  'th',
  ...
  'Message Unavailable',
  'Instagram Share',
  "Are you sure you want to revoke this app's access?",
  ...
  'February',
  'Change Your Password to Secure Your Account',
  '© {year} {Text that shows branding for Facebook on Instagram Web}',
  ...
  'Submit Appeal',
  'Please provide your contact information. This will be shared with {reference owner name} so they can contact you about your appeal. (Required)',
  'Quizzes',
  ...
  'expired',
  'Search',
  "You'll no longer receive invite messages by SMS.",
  ...
  'Comment removed for {violationText}',
  'Get the App to Use Stickers',
  '{reference owner name} has rejected your dispute. You have 7 days to appeal.',
  ...
  'You have {max_count} active accounts and have reached the maximum.',
  'th',
  'Trouble Logging In?',
  'Story removed',
  'IGTV',
  ...
  "The information you provide here and your video will be reviewed by {reference owner name}, and they'll have 7 days to respond to your appeal. If {reference owner name} rejects your appeal and requests a takedown of your video, your video may be removed. Having multiple videos removed due to takedown requests could result in your account being suspended.",
  ...
  'Date joined',
  'Connect Contacts',
  "You might be able to post your video if the matched content in question isn't the main focus of your video, if you're commenting on the content or if it's a parody video.",
  ...
  'Scroll back',
  'Post a Preview',
  'Contact Invites Opt-Out status',
  'June',
  'Profiles',
  ...
  'Take a Second to Rate Instagram Lite',
  'Enter valid email',
  'Sign up with {email} or {phone number}',
  ...
  'Delete',
  'Reason for dispute',
  'Mentioned {username} in their story',
  'Watch on Instagram',
  'Request Appeal',
  'Graphic violence',
  ...
  '{Type of the message} Message Unavailable',
  ...
  'Blocked',
  'Billing Address',
  "Backup codes are useful if you lose accesss to your phone number and can't receive a security code by text.",
  'Restore Video',
  'Log in to follow.',
  '@generated',
  'th',
  ...
  "The people listed here are contacts you've uploaded to Instagram. To remove your synced contacts, tap Delete All. If you delete your contacts from this page, new contacts you add to your phone will be uploaded. If you want to stop syncing, go to your device settings and turn off access to contacts.",
  'Undo',
  'Video Call',
  'Add Gift Aid',
  ...
  'Mentioned {username} in your story',
  'Leave Conversation',
  ...
  'Keep',
  'Limit Login Help Emails',
  'You acknowledge that you are a UK taxpayer and understand that if you pay less Income Tax or Capital Gains Tax than the amount of Gift Aid claimed on all your donations in the current tax year, it is your responsibility to pay any difference. You confirm that all of the above statements apply.',
  'The following information you provide and your video will be reviewed by {reference owner name} who will have 7 days to respond to your dispute. By submitting a dispute, you give {reference owner name} permission to review your video and information that may allow them to identify your account. Your video will remain blocked while they review your dispute.',
  ...
  "· The funds used aren't the proceeds from the sale of goods or provision of services",
  'Phone Number',
  'Next',
  ...
  'Live removed for {violationText}',
  'Get the App',
  'Delete',
  ...
  'You can Gift Aid your donation if all of the following statements apply:',
  'Your Story',
  'No',
  ...
  'Manage Accounts',
  'Post removed for {violationText}',
  ...
  'Parental Approval',
  'Instagram will send updates to this email address. Your name will be shared with the organization receiving your donation.',
  'Directory',
  'Submit',
  'State',
  ...
  'Copy Link',
  'Female',
  'Recover your account more quickly',
  'answers and advice',
  'Seen',
  'Name',
  'Not Now',
  ...
  'Tell us if you love it, or let us know how to make it better.',
  'Register',
  ...
  'At this time, some Stickers are only available on the Instagram App.',
  'OK',
  ...
  'Your video was blocked because it may contain music, audio or video that belongs to someone else.',
  'Getting Started',
  'Posts',
  'Follow people you know',
  'Clear Search History',
  ...
  "You won't get messages from this group unless someone adds you back to the conversation.",
  'Next',
  'Done',
  'Got it',
  'Report as spam?',
  ...
  'nd',
  'Gender',
  "Turning on two-factor authentication means we'll text you a security code to enter every time you log in.",
  'Edit Draft',
  'Regulated goods',
  'Specific threats of physical harm, theft, vandalism or financial harm.',
  ...
  'Get Started',
  'We can only send you a new code every 30 seconds.',
  'Search',
  'Cancel',
  'Send Report',
  ...
  'Story removed for {violationText}',
  ...
  'Add a comment…',
  'Followers',
  'Your video must be between {minDurationInSeconds} seconds and {maxDurationInMinutes} minutes long, an MP4 file and less than {maxVideoSizeInGigabytes} GB.',
  'Unfollowed',
  'resend it',
  'Filter: {filter title}',
  ...
  "Do you want to let {username} send you messages from now on? They'll only know you've seen their request if you choose Allow.",
  ...
  '{Submit a dispute text bolded} if you feel this is a mistake and you have the rights to use all of the content in your video. Your video will remain blocked while {reference owner name} reviews your dispute.',
  'Error',
