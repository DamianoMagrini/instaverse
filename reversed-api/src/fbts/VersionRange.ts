 ...
 * @returns {boolean}
 */
function checkOrExpression(range: string, version: string): boolean {
 ...
 * @returns {boolean}
 */
function checkRangeExpression(range: string, version: string): boolean {
 ...
 * @returns {boolean}
 */
function checkSimpleExpression(range: string, version: string): boolean {
  range = range.trim();
 ...
 * @returns {boolean}
 */
function checkLessThan(a: string[], b: string[]): boolean {
 ...
 * @returns {boolean}
 */
function checkLessThanOrEqual(a: string[], b: string[]): boolean {
 ...
 * @returns {boolean}
 */
function checkEqual(a: string[], b: string[]): boolean {
 ...
 * @returns {boolean}
 */
function checkGreaterThanOrEqual(a: string[], b: string[]): boolean {
  const result = compareComponents(a, b);
  return result === 1 || result === 0;
}
 ...
 * @returns {boolean}
 */
function checkGreaterThan(a: string[], b: string[]): boolean {
  return compareComponents(a, b) === 1;
}
 ...
 * @returns {boolean}
 */
function checkApproximateVersion(a: string[], b: string[]): boolean {
 ...
 */
function getModifierAndComponents(range: string) {
 ...
 * (">", "~" etc).
 */
function isSimpleVersion(range: string): boolean {
 ...
 * @param {number} length
 */
function zeroPad(array: any[], length: number) {
 ...
 */
function normalizeVersions(a: string[], b: string[]): string[][] {
  a = a.slice();
  b = b.slice();
