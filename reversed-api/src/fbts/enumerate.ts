...
const ArrayIterators = (function() {
  ...
  return {
    keys: hasNative
      ? (array: any[]) => array.keys()
      : (array: any[]) => new ArrayIterator(array, KIND_KEYS),
    values: hasNative
      ? (array: any[]) => array.values()
      : (array: any[]) => new ArrayIterator(array, KIND_VALUES),
    entries: hasNative
      ? (array: any[]) => array.entries()
      : (array: any[]) => new ArrayIterator(array, KIND_ENTRIES)
  };
})();
...
const StringIterators = string_iterator_factory();

function hasNativeIterator(classObject) {
  return (
    typeof classObject.prototype[Symbol.iterator] === 'function' &&
...
class ObjectIterator {
  _iteratedObject: { [key: string]: any };
  _kind;
  _keys: string[];
  _nextIndex: number;

  constructor(object: { [key: string]: any }, kind: any) {
 ...
 */
function enumerate(object: any, kind?) {
