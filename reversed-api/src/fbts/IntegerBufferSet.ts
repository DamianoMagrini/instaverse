...
class IntegerBufferSet {
  private _valueToPositionMap: { [value: number]: any };
  private _size: number;
  private _smallValues: Heap;
  private _largeValues: Heap;
  ...
  getValuePosition = (value: number) =>
    this._valueToPositionMap[value] === undefined
      ? null
      : this._valueToPositionMap[value];
  ...
  replaceFurthestValuePosition(
    ...
    let valueToReplace: string | number;
  ...
  _smallerComparator = (lhs: { value: number }, rhs: { value: number }) =>
    lhs.value < rhs.value;

  _greaterComparator = (lhs: { value: number }, rhs: { value: number }) =>
    lhs.value > rhs.value;
}
